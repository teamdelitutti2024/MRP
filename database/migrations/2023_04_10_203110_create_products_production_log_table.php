...
class CreateProductsProductionLogTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('products_production_log', function (Blueprint $table) {
            $table->increments('id');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('products_production_log');
    }
}
