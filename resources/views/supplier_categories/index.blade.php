...
<div class="page-title">
    <h5><i class="fa fa-tag"></i> {{ __('Administración de categorías de proveedores') }}</h5>
</div>
<!-- /page title -->
...
<div id="modal-add-row" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/supplier_categories/store') }}" role="form" method="POST" autocomplete="off">
                @csrf
...
<div id="modal-edit-row" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/supplier_categories/update') }}" role="form" method="POST" autocomplete="off" id="form-edit">
                @csrf
                <div class="modal-body has-padding">
                    <div class="form-group">
                        <label><span class="mandatory">*</span> {{ __('Nombre') }}</label>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.edit-link').click(function() {
            ...
            $.ajax({
                url: '{{ url('/supplier_categories/get_row') }}',
                data: 'id=' + row_id,
                dataType: 'json',
                type: 'post',
                cache: false,
                success: function(data) {
                    ...
                    $('#form-edit').attr('action', '{{ url('/supplier_categories/update/') }}/' + row_id);
                }
            });
        });
    });
