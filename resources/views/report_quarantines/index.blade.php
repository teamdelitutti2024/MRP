...
<div class="page-title">
    <h5><i class="fa fa-tag"></i> {{ __('Reporte de Cuarentenas') }}</h5>
</div>
<!-- /page title -->
...
<div class="panel panel-default">
    <div class="panel-body">
        <form action="{{ url('/reports/quarantines') }}" type="GET" >
            <div class="row">
                <div class="col-sm-3">
                ...
                <div style="margin-top: 27px;">
                    ...
                    <div class="col-sm-2">
                        <a href="{{ url('/reports/quarantines') }}" class="btn btn-default">{{ __('Limpiar') }}</a>
                    </div>
                    <div class="col-sm-2">
                        <a href="{{ url('/reports/quarantines/download') }}?from_date={{ $from_date }}&to_date={{ $to_date }}&supply_key={{ $supply_key }}" class="pull-right btn btn-success"><i class="fa fa-download"></i> {{ __('Descargar PDF') }}</a>
                    </div>
                    <div class="col-sm-2">
                        <a href="{{ url('/reports/quarantines/export') }}?from_date={{ $from_date }}&to_date={{ $to_date }}&supply_key={{ $supply_key }}" class="pull-right btn btn-success"><i class="fa fa-download"></i> {{ __('Descargar Excel') }}</a>
                    </div>
                </div>
            </div>
        </form>
